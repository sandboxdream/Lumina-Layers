...
| Feature | Description |
|---------|-------------|
| 🔗 **Keychain Loop** | Add functional hanging loops with auto-color detection |
| 🎨 **Loop Shape** | Rectangle bottom + semicircle top + hollow hole |
| 👁️ **2D Preview** | Click to place loop; real-time preview with rotation |
| 🎯 **Smart Color** | Automatically matches loop color to nearby model pixels |
